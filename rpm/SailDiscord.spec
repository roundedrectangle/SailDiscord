...
python3 -m pip install --no-cache-dir --force-reinstall https://github.com/roundedrectangle/pyotherside-utils/releases/download/latest/pyotherside_utils-1.0-py3-none-any.whl

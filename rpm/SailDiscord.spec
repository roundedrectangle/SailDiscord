...
python3 -m pip install --upgrade "git+https://github.com/dolfies/discord.py-self@20ae80b398ec83fa272f0a96812140e14868c88f" "requests" "yarl" --target=%_builddir/deps
